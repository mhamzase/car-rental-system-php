...
if (isset($_POST['register'])) {
    ...
    if ($count_email) {
        ...
        $sql = "INSERT INTO `users`(`fullname`, `email`, `password`, `type`,`token`) VALUES ('$fullname','$email','$password','$type'   ,'$token')";

        if (mysqli_query($conn, $sql)) {
            header("Location: register.php?success=You are registered successfully!");
            $_POST['fullname'] = "";
            $_POST['email'] = "";
            $_POST['password'] = "";
        }
                        ...
                        <div class="contact-form">
                            <form id="contact" action="" method="post">
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <fieldset>
                                            <button type="submit" name="register" id="register" class="filled-button">Create an account</button>
                                        </fieldset>
                                    </div>
                                </div>
                            </form>
